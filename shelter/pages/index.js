...
4. Интерактивность элементов **+12**
   ...
   (Логотип - изменение цвета текста Cozy House при наведении (едва заметно, но есть). Интерактивность ссылок в хедере на странице Pets едва заметна, но она есть (изменение цвета текста). Интерактивность ссылок в футере выполнена изменением цвета. Указатель номера страницы каталога с животными сделан неинтерактивным, он постоянно в состоянии Active)
