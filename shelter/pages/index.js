...
4. Интерактивность элементов **+14**
   ...
   (По макету не совсем ясно, как устроена пагинация и каким должно быть поведение кнопки с номером страницы. Реализовала, как наиболее типичное поведение - кнопка активной страницы подсвечена и не интерактивна)
   - каждая карточка с питомцем в блоке **Our Friends** интерактивна при наведении на любую область этой карточки **+2**
   - плавная прокрутка по якорям **+2**
