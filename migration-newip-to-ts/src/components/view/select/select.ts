...
export default class Select {
    public draw(optionsConfig: Record<string, string>, selectElement: HTMLSelectElement): void {
        ...
        optionsArray.forEach((optionsItem: readonly [string, string]) => this.addOptions(optionsItem, selectElement));
    }

    private addOptions(optionsItem: readonly [string, string], selectElement: HTMLSelectElement): void {
